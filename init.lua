  ...
  },
  {
    ...
    config = function()
      ...
      require('mason-lspconfig').setup {
        ensure_installed = {}, -- Tools are installed via mason-tool-installer above.
      ...
      -- nixd is installed by Nix rather than Mason.
      vim.lsp.config('nixd', {
    ...
    config = function()
      ...
      local function start(bufnr)
        ...
        if vim.list_contains(treesitter.get_installed('parsers'), lang) then
          ...
          if ok and not indent_disabled[filetype] then
            vim.bo[bufnr].indentexpr = "v:lua.require'nvim-treesitter'.indentexpr()"
          end
          return
        end

        if installing[lang] or not available[lang] then
          return
        end
